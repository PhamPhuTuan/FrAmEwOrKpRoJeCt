...
namespace firstWeb.Controllers
{
    public class SinhVienController : Controller
    {
        ...
        [Route("/SinhVien/LietKeSinhVienCuaBoMon_Ajax/{maBomon}")]
        public IActionResult LietKeSinhVienCuaBoMon_Ajax(string MaBoMon)
        {
            StoreContext context = HttpContext.RequestServices.GetService(typeof(firstWeb.Models.StoreContext)) as StoreContext;
        ...
        public IActionResult LietKeCacSinhVien(int SoSinhVien, int SoSinhVien1)
        {
            StoreContext context = HttpContext.RequestServices.GetService(typeof(firstWeb.Models.StoreContext)) as StoreContext;

            return View(context.LietKeNSinhVien(SoSinhVien1));
        }
